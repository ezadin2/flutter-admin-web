                ...
                children: [
                  ...
                  Expanded(
                    child: Obx(
                        ...
                        // Assuming you have visitor data by month in your customer controller
                        // This is a placeholder - you'll need to implement proper visitor tracking
                        final previousMonthVisitors = (currentVisitors * 0.9).round(); // Example

                        final percentage = controller.calculatePercentageChange(
                            currentVisitors.toDouble(),
                            previousMonthVisitors.toDouble()
                        );
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: [
                        // Bar Graph
                        TSalesGraph(showWeekly: controller.weeklySales.any((sale) => sale > 0)),
                        SizedBox(height: TSizes.spaceBtwSections),
