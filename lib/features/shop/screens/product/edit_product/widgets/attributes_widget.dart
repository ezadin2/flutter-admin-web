...
import 'package:ecommerce_admin_panel/features/shop/screens/product/create_product/widgets/variations_widget.dart';
...
class ProductAttributes extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final variationControler = Get.put(ProductVariationController());
    ...
    return Column(
      ...
      children: [
        ...
        TRoundedContainer(
          ...
          child: Obx(() => attributeController.productAttribute.isNotEmpty
              ? ListView.separated(
                  shrinkWrap: true,
                  ...
                  itemBuilder: (_, index) {
                    return Container(
                      ...
                      child: ListTile(
                        title: Text(
                            attributeController.productAttribute[index].name ??
                                ''),
              ...
              : Column(
                  children: [
                    ...
                    Text('There is no Attributes added fo these product')
                  ],
                )),
        ),
        SizedBox(height: TSizes.spaceBtwSections),
        Obx(
    ()=>productController.productType.value == ProductType.variable && variationControler.productVariations.isEmpty ? Center(
            child: SizedBox(
              width: 200,
              child: ElevatedButton.icon(
                icon: Icon(Iconsax.activity),
                label: Text('generate variation'),
                onPressed: () => variationControler.generateVariationsConfirmation(context),
              ),
            ),
          ):SizedBox.shrink(),
        )
